...
add_definitions(
    -DDEBUG_PRINT # Define FOR_DEBUG to enable debug printing
    -DVIMC_APP_DEBUG #Define debugging flag for VITT
    -DCALC_DISPARITY_USE_DYNAMIC_ALLOCATION # Calculating disparity map using dynamic allocation
)

set(CMAKE_EXPORT_COMPILE_COMMANDS ON)
set(MISISON_PLATFORM "linux")

# set(WITH_OPENCV ON)

# Check if WITH_OPENCV is set to ON
# if(WITH_OPENCV)
#     # Find OpenCV package
...
# else()
#     set(OPENCV_LIBS "")
#     message(FATAL_ERROR "OpenCV can't be found")
# endif()
