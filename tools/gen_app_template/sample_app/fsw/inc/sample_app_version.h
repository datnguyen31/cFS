...
#define SAMPLE_APP_BUILD_DEV_CYCLE                                                                 \
    "equuleus-rc2" /**< @brief Development: Release name for current development cycle */
#define SAMPLE_APP_BUILD_CODENAME                                                                  \
...
#define SAMPLE_APP_REVISION                                                                        \
    0 /*!< @brief Revision version number. Value of 0 indicates a development version.*/
 ...
 * Values 1-254 are reserved for mission use to denote patches/customizations as needed. NOTE:
 * Reserving 0 and 0xFF for cFS open-source development use (pending resolution of nasa/cFS#440)
 */
#define SAMPLE_APP_MISSION_REV 0xFF

#define SAMPLE_APP_STR_HELPER(x)                                                                   \
    #x /*!< @brief Helper function to concatenate strings from integer macros */
#define SAMPLE_APP_STR(x)                                                                          \
    SAMPLE_APP_STR_HELPER(                                                                         \
        x) /*!< @brief Helper function to concatenate strings from integer macros */
