...
public abstract class CcddInputFieldPanelHandler
{
    ...
    {
        Color backColor = enable ? ModifiableColorInfo.INPUT_BACK.getColor()
        ...
        for (FieldInformation fieldInfo : fieldInformation)
        {
                                                   ...
                                                   fieldInfo.getApplicabilityType().getApplicabilityName(), null)))
            {
                ...
                if (fieldInfo.getInputType().getInputFormat() == InputTypeFormat.BOOLEAN)
                {
                    ...
                    // state
                    fieldInfo.setValue(((JCheckBox) inputFld).isSelected() ? "true" : "false");
                }
                        ...
                        default:
                                ...
                                || fieldInfo.getInputType().equals(inputTypeHandler.getInputTypeByDefaultType(DefaultInputType.TEXT_MULTI_WHT_SPC)))
                            {
                                ...
                                UndoableTextArea undoableTxtArea = undoHandler.new UndoableTextArea(
                                        fieldInfo.getValue(), ModifiableSizeInfo.MAX_DATA_FIELD_ROWS.getSize(),
                                        fieldInfo.getSize());
                                ...
                                undoableTxtArea.setFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS,
                                                                      null);
                                undoableTxtArea.setFocusTraversalKeys(KeyboardFocusManager.BACKWARD_TRAVERSAL_KEYS,
                                                                      null);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    ((UndoableComboBox) inputFld).setSelectedItem(fieldInfo.getValue(), false);
                                }
                            }
