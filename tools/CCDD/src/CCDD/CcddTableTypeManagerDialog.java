        ...
        switch (dialogType)
        {
            ...
            case RENAME:
                    ...
                    && !activeTypeName.equals(typeNameFld.getText()))
                {
                    ...
                    dbTable.renameTableType(activeTypeName, typeNameFld.getText(), CcddTableTypeManagerDialog.this);
                }
            ...
            case DELETE:
                                      ...
                                      DialogOption.DELETE_OPTION) == OK_BUTTON)
                {
                    ...
                    dbTable.deleteTableType(savedDefn, CcddTableTypeManagerDialog.this, editorDialog);
                }
            ...
            switch (dialogType)
            {
                ...
                case COPY:
                    ...
                    for (String type : types)
                    {
                        ...
                        // insensitive)
                        if (type.equalsIgnoreCase(typeNameFld.getText()) && !type.equals(activeTypeName))
                        {
