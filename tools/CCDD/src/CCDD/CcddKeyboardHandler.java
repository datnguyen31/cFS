...
public class CcddKeyboardHandler
{
            ...
            public boolean dispatchKeyEvent(final KeyEvent ke)
            {
                    ...
                    && !ke.isAltDown())
                {
                    ...
                    else if (ke.isActionKey())
                    {
                        ...
                        else if (comp instanceof JTextField && comp.getParent() instanceof JComboBox)
                        {
                ...
                else if (ke.getID() == KeyEvent.KEY_PRESSED && ke.isControlDown() && !ke.isAltDown())
                {
                    ...
                    else if (ke.getKeyCode() == KeyEvent.VK_S)
                    {
                                 ...
                                 && modalTable.isEditing())
                        {
                            ...
                            if ((column == DataTypeEditorColumnInfo.USER_NAME.ordinal()
                                ...
                                && (baseType.isEmpty() || baseType.equals(BaseDataTypeInfo.POINTER.getName())))
                            {
                                // Insert the structure name chosen by the user into the text field
                                // at the current text insertion point
                                new PopUpComboBox(SwingUtilities.getWindowAncestor(comp),
                    ...
                    else if (ke.getKeyCode() == KeyEvent.VK_E && comp instanceof CcddCommonTreeHandler)
                    {
                             ...
                             || ke.getKeyCode() == KeyEvent.VK_M))
                {
                    ...
                    // Alt-Shift-M
                    DefaultInputType refInputType = ke.getKeyCode() == KeyEvent.VK_V ? DefaultInputType.VARIABLE_REFERENCE
                                                                                     : (ke.getKeyCode() == KeyEvent.VK_C ? DefaultInputType.COMMAND_REFERENCE
                         ...
                         && comp instanceof JTextArea)
                {
                    ...
                    if ((editorDialog != null && editorDialog.getTableEditor().getTable().isEditing())
    ...
    private CcddUndoManager getActiveUndoManager()
    {
        ...
        else
        {
            ...
            if (focusOwner != null && (focusOwner instanceof UndoableTextField
