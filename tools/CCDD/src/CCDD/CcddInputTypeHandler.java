...
public class CcddInputTypeHandler
{
    ...
    protected boolean isInputTypeChanged(InputType inputTypeA, InputType inputTypeB)
    {
        return !inputTypeA.getInputName().equals(inputTypeB.getInputName())
               ...
               || (inputTypeA.getInputItems() != null && inputTypeB.getInputItems() != null
            ...
            try
            {
                switch (inputFormat)
                {
                    ...
                    case HEXADECIMAL:
                        ...
                        // ID or not
                        String protect = valueS.endsWith(PROTECTED_MSG_ID_IDENT) ? PROTECTED_MSG_ID_IDENT : "";
                        ...
                        valueS = String.format("0x%s%x", (preserveZeroes ? leadZeroes : ""), value) + protect;
                        break;
                    ...
                    case MESSAGE_ID:
                        ...
                        if (values.length == 1 && valueS.matches(DefaultInputType.HEXADECIMAL.getInputMatch()))
                        {
                            // Format the message ID
                            valueS = formatInput(valueS, InputTypeFormat.HEXADECIMAL, preserveZeroes);
                        }
                        ...
                        else if (values.length == 2)
                        {
                            ...
                            valueS = values[0] + " "
                                     + formatInput(values[1], InputTypeFormat.HEXADECIMAL, preserveZeroes);
                        }
