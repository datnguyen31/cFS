...
public class CcddFieldEditorDialog extends CcddDialogHandler
{
                          ...
                          int minimumWidth)
    {
        ...
        fieldPnlHandler.getUndoFieldPanel().setUndoFieldInformation(CcddFieldHandler.getFieldInformationCopy(fieldInformation));
    ...
    private void initialize(final int minimumWidth)
    {
            ...
            public Component prepareRenderer(TableCellRenderer renderer, int row, int column)
            {
                ...
                if (!(isRowSelected(row) && (isColumnSelected(column) || !getColumnSelectionAllowed())))
                {
                    ...
                    else if (column == inputTypeIndex && inputTypeCbox != null)
                    {
                        ...
                        if (inputTypeHandler.getInputTypeByName(fieldTable.getValueAt(row, column).toString())
                                            .getInputFormat()
                                            .equals(InputTypeFormat.PAGE_FORMAT))
                        {
                            found = true;
        ...
        btnSeparator.addActionListener(new ValidateCellActionListener(fieldTable)
        {
            ...
            protected void performAction(ActionEvent ae)
            {
                fieldTable.insertRow(true, TableInsertionPoint.SELECTION,
    ...
    private void recreateDataFieldPanel(int minDialogWidth)
    {
        ...
        for (FieldInformation fieldInfo : fieldHandler.getFieldInformationFromData(currentData, ownerName))
        {
