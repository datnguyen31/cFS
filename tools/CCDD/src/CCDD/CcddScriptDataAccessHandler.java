...
public class CcddScriptDataAccessHandler
{
    ...
    // Name and description of the script file being executed
     ...
     *
     * @param scriptDescription Description of the script file being executed
     *
    ...
    /**********************************************************************************************
     * Get the description of the script file being executed
     *
     * @return Description of the script file being executed
     *********************************************************************************************/
    ...
    public Integer[] getLongestStrings(List<List<String>> strgList, List<Integer> minWidths)
    {
        return getLongestStrings(CcddUtilities.convertListToArray2D(strgList, String.class),
                                 (minWidths == null ? null : CcddUtilities.convertListToArray1D(minWidths, Integer.class)));
    }
     ...
     *
     * @param index 0 = redLow, 1 = yellowLow, 2 = yellowHigh, 3 = redHigh
     *
     * @return ITOS limit name; returns blank if the index is invalid
     *********************************************************************************************/
    public String getITOSLimitName(int index)
    {
        String[] limitNames = new String[] {"redLow", "yellowLow", "yellowHigh", "redHigh", ""};
            ...
            if (memberPaths.size() > 1)
            {
                ...
                for (int index = 1; index < memberPaths.size(); index++)
                {
                    ...
                    if (!target.equals(compare)
                        && (!isExternal || isTargetExternal || !structureTableNames.contains(compare)))
                    {
    ...
    public String[][] getTableDataFieldValues(String tableType, String fieldName)
    {
        ...
        for (String tableName : (tableType == null ? getTableNames() : getTableNames(tableType)))
        {
     ...
     *********************************************************************************************/
    public String getStructureDataByVariableName(String tablePath, String variableName, String columnName)
    {
        return getTableDataByColumnName(TYPE_STRUCTURE, tablePath, "Variable Name", variableName, columnName);
    }
                                          ...
                                          boolean optimize)
    {
        ...
        return getCopyTableEntries(streamName, headerSize, messageIDNameField, null, optimize, true);
    }
                                                    ...
                                                    boolean optimize)
    {
        ...
        return getCopyTableEntries(streamName, headerSize, messageIDNameField, null, optimize, false);
    }
                                                    ...
                                                    boolean optimize)
    {
        ...
        // Create the copy table with macros unexpanded
        return getCopyTableEntries(streamName, headerSize, null, tlmMessageIDsList, optimize, false);
    }
