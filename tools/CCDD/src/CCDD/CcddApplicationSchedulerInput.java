                                                   ...
                                                   ccddMain.getMainFrame())
        {
            ...
            protected void updateTableSelection()
            {
                ...
                if (!isNodeSelectionChanging)
                {
                    ...
                    // are unselected, so this call must occur first
    ...
    private List<Variable> getApplicationFields(String[] applications, String rate)
    {
        ...
        for (String application : applications)
        {
            ...
            appList.add(new ApplicationData(application,
                                            ...
                                            getDataFieldValue(application, DefaultApplicationField.WAKE_UP_MESSAGE),
                                            Integer.valueOf(getDataFieldValue(application,
                                                                              DefaultApplicationField.HK_SEND_RATE)),
                                            getDataFieldValue(application, DefaultApplicationField.HK_WAKE_UP_MESSAGE),
                                            getDataFieldValue(application, DefaultApplicationField.SCH_GROUP)));
        }
