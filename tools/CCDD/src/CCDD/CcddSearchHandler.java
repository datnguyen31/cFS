            ...
            while (lineMatch.find())
            {
                ...
                if (targetRow == null || row == targetRow)
                {
                    ...
                    for (int column = 0; column < parts.length; column++)
                    {
                        ...
                        {
                            // Add the search result to the list
                            matchDataList.add(new Object[] {row, eventLog.getEventTable().getColumnName(column + 1),
                                                            parts[column]});
                        }
                    }
                    ...
                    // entry row search
                    if (lineMatch.end() == charBuffer.limit() || targetRow != null)
                    {
                        // Exit the loop
                        break;
                    }
            ...
            public int compare(Object[] entry1, Object[] entry2)
            {
                ...
                if (result == 0)
                {
                        ...
                        && entry2[1].toString().matches("Column '.*', variable '.*\\]'"))
                    {
                        ...
                        String arrayVariable1 = entry1[1].toString().replaceFirst("Column '.*', variable '(.*\\])'",
                                                                                  "$1");
                        String arrayVariable2 = entry2[1].toString().replaceFirst("Column '.*', variable '(.*\\])'",
                                                                                  "$1");
