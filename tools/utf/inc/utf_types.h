...
typedef char (*utf_write_sim_hook_type)(unsigned long int address, unsigned short int num_bytes,
                                        void* data_ptr);
typedef char (*utf_read_sim_hook_type)(unsigned long int address, unsigned short int num_bytes,
                                       void* data_ptr);
