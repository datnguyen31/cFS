...
**
** Purpose: This module defines the UTF specific function prototypes for the functions contained in
*utf_bsp_support.c
**
** References:
**
...
** Added code to allow the return code setting capability of the UTF to be used on the 2 new BSP
*functions.
