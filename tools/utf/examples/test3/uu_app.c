...
*c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/tools/utf/examples/test3/project.pj
** Revision 1.3 2007/06/05 08:24:50EDT wfmoleski
** Changes to examples and utf source that reflect the cFE 4.1.0 ES subsystem.
** Revision 1.2 2006/08/01 08:46:50EDT wfmoleski
** Changes to upgrade this example to cFE 3.3.0
** Revision 1.1 2006/03/21 16:44:15EST sslegel
** Initial revision
...
void UU_AppMain(void)
{
    ...
    */
    ...
    while (TRUE)
    {
        ...
        */
        Status = CFE_SB_RcvMsg(&UU_AppData.MsgPtr, UU_AppData.CmdPipe, 4);
        ...
        if (1)
        {
            ...
            Status2 = CFE_EVS_SendEvent(UU_INIT_INF_EID, CFE_EVS_INFORMATION,
...
void UU_AppInit(void)
{
    ...
    */
    CFE_EVS_Register(UU_AppData.EventFilters, UU_EVT_COUNT, CFE_EVS_BINARY_FILTER);

    /*
    ** Initialize housekeeping packet (clear user data area)...
    */
    CFE_SB_InitMsg(&UU_AppData.HkPacket, CFE_UU_HK_TLM_MID, sizeof(UU_HkPacket_t), TRUE);

    /*
    ** Create Software Bus message pipe...
    */
    CFE_SB_CreatePipe(&UU_AppData.CmdPipe, UU_AppData.PipeDepth, UU_AppData.PipeName);
    ...
    */
    CFE_EVS_SendEvent(UU_INIT_INF_EID, CFE_EVS_INFORMATION, "UU: Application Initialized");
