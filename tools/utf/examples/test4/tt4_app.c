...
*c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/tools/utf/examples/test4/project.pj
...
void TT_AppMain(void)
{
    ...
    */
    ...
    while (TRUE)
    {
        ...
        */
        Status = CFE_SB_RcvMsg(&TT4_AppData.MsgPtr, TT4_AppData.CmdPipe, 4);
...
void TT_AppInit(void)
{
    ...
    */
    CFE_EVS_Register(TT4_AppData.EventFilters, TT_EVT_COUNT, CFE_EVS_BINARY_FILTER);

    /*
    ** Initialize housekeeping packet (clear user data area)...
    */
    CFE_SB_InitMsg(&TT4_AppData.HkPacket, CFE_TT_HK_TLM_MID, sizeof(TT_HkPacket_t), TRUE);

    /*
    ** Create Software Bus message pipe...
    */
    CFE_SB_CreatePipe(&TT4_AppData.CmdPipe, TT4_AppData.PipeDepth, TT4_AppData.PipeName);
    ...
    */
    Status = CFE_TBL_Register(&TT4_AppData.TblHandle, "FourNumbers", 4, /* size of table in bytes*/
                              CFE_TBL_OPT_DBL_BUFFER | CFE_TBL_OPT_LOAD_DUMP,
                              &TT_TableValidationCallbackFunc);
    /*                     NULL);  */
    UTF_put_text("CFE_TBL_Register returned %lx\n", Status);

    Status = CFE_TBL_Load(TT4_AppData.TblHandle, CFE_TBL_SRC_FILE, "/ram/tt_table_values0.dat");
