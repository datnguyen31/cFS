...
int main(void)
{
    ...
    UTF_put_text("CFE_ES_GetPoolBuf returned %x. Expected %x\n",
                 CFE_ES_GetPoolBuf((uint32**)&BufPtr3, HandlePtr1, 40000),
    ...
    UTF_put_text("\nTest Case #5: Call CFE_ES_GetPoolBuf with HandlePtr1 and size > remaining pool "
                 "resources (size=2000).\n");
    UTF_put_text("CFE_ES_GetPoolBuf returned %x. Expected %x\n",
    ...
    UTF_put_text("\nTest Case #3: Call CFE_ES_GetPoolBuf following buffer release with HandlePtr1 "
                 "and valid size=32.\n");
    UTF_put_text("CFE_ES_GetPoolBuf returned %d. Expected %d\n",
                 CFE_ES_GetPoolBuf((uint32**)&BufPtr1, HandlePtr1, 32), 32);
