...
*c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/tools/utf/examples/test8/project.pj
...
{
    OS_time_t OS_time;
    double    double_time[10] = {0.57,   0.58,   256.51,   256.52,   256.53,
                                 256.57, 256.58, 0.009999, 0.009996, 0.009994};
    int       i;
