...
int main(void)
{
    ...
    UTF_put_text("CFE_PSP_MemRangeSet(0,RAM,%x,%x,BYTE,RW) returned 0x%08x. Expected 0x%08x\n",
                 0x1000, 0x100,
                 CFE_PSP_MemRangeSet(0, CFE_PSP_MEM_RAM, 0x1000, 0x100, CFE_PSP_MEM_SIZE_BYTE,
                                     CFE_PSP_MEM_ATTR_READWRITE),
                 CFE_PSP_SUCCESS);
    UTF_put_text("CFE_PSP_MemRangeSet(1,EEPROM,%x,%x,BYTE,RW) returned 0x%08x. Expected 0x%08x\n",
                 0x2000, 0x100,
                 CFE_PSP_MemRangeSet(1, CFE_PSP_MEM_EEPROM, 0x2000, 0x100, CFE_PSP_MEM_SIZE_BYTE,
                                     CFE_PSP_MEM_ATTR_READWRITE),
                 CFE_PSP_SUCCESS);
    ...
    UTF_put_text("CFE_PSP_MemRangeSet Return Code %x\n",
                 CFE_PSP_MemRangeSet(maxRangeNum + 1, CFE_PSP_MEM_RAM, 0x1000, 0x100,
    ...
    UTF_put_text("CFE_PSP_MemRangeSet(0,%d,%d,%d,BYTE,RW) returned 0x%08x. Expected 0x%08x\n",
                 ...
                 CFE_PSP_MemRangeSet(0, CFE_PSP_MEM_INVALID, 0x1000, 0x100, CFE_PSP_MEM_SIZE_BYTE,
                                     CFE_PSP_MEM_ATTR_READWRITE),
                 CFE_PSP_INVALID_MEM_TYPE);
    UTF_put_text(
        "CFE_PSP_MemRangeSet(0,RAM,%d,%d,%d,RW) returned 0x%08x. Expected 0x%08x\n", 0x1000, 0x100,
        3, CFE_PSP_MemRangeSet(0, CFE_PSP_MEM_RAM, 0x1000, 0x100, 3, CFE_PSP_MEM_ATTR_READWRITE),
    ...
    UTF_put_text(
        "CFE_PSP_MemRangeGet Return Code %x\n",
    ...
    UTF_put_text(
        "CFE_PSP_MemRangeGet(%d,validPtrs) returned 0x%08x. Expected 0x%08x\n", maxRangeNum + 1,
        CFE_PSP_MemRangeGet(maxRangeNum + 1, &memType, &startAddr, &byteSize, &wordSize, &attribs),
        CFE_PSP_INVALID_MEM_RANGE);
    UTF_put_text("CFE_PSP_MemRangeGet(0,invalidPtr,validPtr,validPtr,validPtr,validPtr) returned "
                 "0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, 0, &startAddr, &byteSize, &wordSize, &attribs),
                 CFE_PSP_INVALID_POINTER);
    UTF_put_text("CFE_PSP_MemRangeGet(0,validPtr,invalidPtr,validPtr,validPtr,validPtr) returned "
                 "0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, &memType, NULL, &byteSize, &wordSize, &attribs),
                 CFE_PSP_INVALID_POINTER);
    UTF_put_text("CFE_PSP_MemRangeGet(0,validPtr,validPtr,invalidPtr,validPtr,validPtr) returned "
                 "0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, &memType, &startAddr, 0, &wordSize, &attribs),
                 CFE_PSP_INVALID_POINTER);
    UTF_put_text("CFE_PSP_MemRangeGet(0,validPtr,validPtr,validPtr,invalidPtr,validPtr) returned "
                 "0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, &memType, &startAddr, &byteSize, NULL, &attribs),
                 CFE_PSP_INVALID_POINTER);
    UTF_put_text("CFE_PSP_MemRangeGet(0,validPtr,validPtr,validPtr,validPtr,invalidPtr) returned "
                 "0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, &memType, &startAddr, &byteSize, &wordSize, 0),
                 CFE_PSP_INVALID_POINTER);
    UTF_put_text("CFE_PSP_MemRangeGet(0,validPtrs) returned 0x%08x. Expected 0x%08x\n",
                 CFE_PSP_MemRangeGet(0, &memType, &startAddr, &byteSize, &wordSize, &attribs),
                 CFE_PSP_SUCCESS);
